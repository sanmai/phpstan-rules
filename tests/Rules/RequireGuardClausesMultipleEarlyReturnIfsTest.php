...
class RequireGuardClausesMultipleEarlyReturnIfsTest extends SingleRuleTestCase
{
    ...
    {
        $this->analyse([__DIR__ . '/../Fixtures/GuardClauses/multiple_early_return_ifs.php'], [
            [
